...
import { getBroadcastChannels } from "@/lib/broadcast";
  ...
  return (
    <div className="mb-8">
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        {matches.map((match) => {
          const channels = getBroadcastChannels(match.broadcast);
                ...
                <div className="mt-3 flex flex-wrap gap-2 border-t pt-2">
                  {channels.map((channel) => (
                    <a
                      ...
                      className="inline-flex items-center gap-1 rounded-full border border-gray-200 bg-gray-50 px-2 py-0.5 text-[11px] text-gray-700 transition hover:border-blue-300 hover:bg-blue-50"
                    >
